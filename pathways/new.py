...
def format_protein_id(protein_id):
    """Helper function to standardize protein ID format"""
...
def batch_format_protein_ids(df, column, chunk_size=10000):
    """Process protein IDs in batches to reduce memory usage"""
...
def main():
    try:
        ...
        # Standardize protein IDs in batches
        ...
        # === Disease selection and protein association ===
        ...
        algorithms = [
            ...
            ("DIAMOnD", lambda m, v: diamond_scores(adj_matrix_sparse, v)),
            ("GCN", lambda m, v: gcn_scores(adj_matrix_sparse, v))
        ]
        ...
        community_props = getCommunityScores(G, assoc_gene_vector)
        ...
        for algo_name in results:
            ...
            print_predictions(algo_name, predictions)  # Removed nodes parameter
